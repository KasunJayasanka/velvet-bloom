...
import com.store.velvetbloom.util.MongoOffsetDateTimeReader;
import com.store.velvetbloom.util.MongoOffsetDateTimeWriter;
...
@Configuration
@EnableMongoRepositories("com.store.velvetbloom.repos")
